...
func New(db *gorm.DB,
	...
	object.handlerMap = map[string]func(db *gorm.DB,
		...
		"distribution": object.onDistributionMessages,
		"evidence":     object.onEvidenceMessages,
		"gov":          object.onGovMessages,
		"mint":         object.onMintMessages,
		"slashing":     object.onSlashingMessages,
		"staking":      object.onStakingMessages,
